...
spr = { // The enemy's sprites
	...
	standing: sEnemyRatIdle,
	walking: sEnemyRatWalking,
	attacking: sEnemyRatAttacking,
	dying: sEnemyRatDying,
...
mask_index = sEnemyRatWalking; // Collision Mask

enemyStats = { // The enemy's stats
	// Movement Stats
	walkSpd: random_range(1, 1.3), // The speed which this enemy walks at
	
	// Combat Stats
	maxHP: 6 * random_range(0.95, 1.05),
	attack: 2 * random_range(0.95, 1.05),
