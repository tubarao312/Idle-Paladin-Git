...
/*
function inputs_component(inputs) { // Processing the inputs
	inputs.jump = input_gamepad(gp_face1);
	inputs.left = input_gamepad(gp_padl);
	inputs.right = input_gamepad(gp_padr);
	inputs.attack = input(ord("C"));
	inputs.spell[0] = input_gamepad(gp_face3);
	inputs.spell[1] = input_gamepad(gp_face2);
	inputs.spell[2] = input_gamepad(gp_face4);
	inputs.interact = input_gamepad(gp_padd);
	
	print(gamepad_get_description(3))
